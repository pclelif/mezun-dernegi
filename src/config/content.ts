import { legalAddress } from "./legal";
...
export const contentSections = {
  ...
  hakkimizda: {
    ...
    defaults: { about_title: "GEÇMİŞİN GÜÇLÜ TEMELLERİYLE GELECEĞE UZANAN KÖPRÜ", about_text: "Mezunlarımızı bir araya getiriyor, okulumuzla olan bağımızı ve birbirimizle olan iletişimimizi canlı tutuyoruz.", vision: "Milli, manevi değerlerimiz ile Türkiye'nin yarınlarına yön veren, Vatansever Şehit Tümgeneral Aydoğan Aydın'ın ismini geleceğe taşımak için tüm mezunlarımızla birlikte güçlü bir sivil toplum kuruluşu olmaktır.", mission: "Keçiören Vatansever Şehit Tümgeneral Aydoğan Aydın Fen Lisesi mezunları ve ailesinin tüm fertleri arasında dayanışmayı ve bağı güçlendirmek; okulumuza yönelik burs, mentorluk ve kariyer desteği sağlayarak eğitim-öğretim faaliyetlerine katkıda bulunmak; toplumsal sorumluluk projeleriyle ülkemiz, milletimiz ve insanlık için fayda üretmektir.", president_message: "Sevgili Mezunlarımız, Kıymetli Öğretmenlerimiz ve Değerli Mensuplarımız,\nOkulumuzun adını onurla taşıyan derneğimizde, kuruluş sürecine başkanlık etmekten ve aktif olarak Yönetim Kurulu Başkanlığını sürdürmekten gurur ve mutluluk duyuyorum. Ortak mirasımız olan Keçiören Vatansever Şehit Tümgeneral Aydoğan Aydın Fen Lisesi'nin bizlere kazandırdığı değerleri yaşatmak ve gelecek nesillere aktarmak en büyük amacımızdır.\n\nBirlikteliğimizi güçlendirerek mezunlarımız ve öğrencilerimiz arasında köprüler kuracak; eğitimden sosyal dayanışmaya kadar pek çok alanda önemli izler bırakacağız. Sizlerin desteği ve katılımıyla derneğimizi çok daha ileriye taşıyacağımıza inancım tamdır.\n\nBirlikte daha güçlüyüz, aramıza hoş geldiniz.", president_image_url: "", charter_url: "" },
  },
  uyelik: {
