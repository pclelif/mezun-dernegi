...
set content = jsonb_build_object(
  ...
  'donation', 'Derneğimize ve okulumuz öğrencilerine destek olmak için aynı IBAN numarasına “Bağış” açıklaması ile dilediğiniz tutarda katkıda bulunabilirsiniz.',
