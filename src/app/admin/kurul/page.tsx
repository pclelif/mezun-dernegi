                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-3.5 whitespace-nowrap align-middle">
                        <span className={`-ml-2.5 inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold -translate-x-[0.75px] ${member.board_type === "audit" ? "bg-purple-50 text-purple-700" : "bg-blue-50 text-blue-700"}`}>
