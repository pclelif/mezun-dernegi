...
export const legalHeadingClass = "text-xl font-semibold text-zinc-950 mt-8 mb-4";
export const legalSubheadingClass = "text-lg font-semibold text-zinc-950 mt-6 mb-2";
  ...
  return (
    <>
      ...
      <main className="container-site section-space">
        <article className="max-w-3xl space-y-6 text-base leading-7 text-zinc-600 [&_strong]:font-semibold [&_strong]:text-zinc-950">
          {children}
        </article>
      </main>
    </>
